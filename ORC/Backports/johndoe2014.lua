...
MainPart = New("Part",LeftArm,"MainPart",{Transparency = 1,FormFactor = Enum.FormFactor.Symmetric,Size = Vector3.new(1, 2, 1),CFrame = CFrame.new(1.90889204, 6.31596565, 3.24640989, -0.0484240092, -0.0324009918, 0.998301268, -0.00117100019, 0.999474883, 0.0323822871, -0.998826265, 0.000399069104, -0.0484365262),CanCollide = false,})
...
local f = Instance.new("Fire", CorruptedPart)
...
MainPart = New("Part",RightArm,"MainPart",{Transparency = 1,FormFactor = Enum.FormFactor.Symmetric,Size = Vector3.new(1, 2, 1),CFrame = CFrame.new(2.011096, 6.31690788, -3.92582893, 0.00918400101, -0.262283146, 0.964947343, 0.259330034, 0.932596445, 0.251021653, -0.965745091, 0.247934431, 0.0765828639),CanCollide = false,})
...
slashsnd = New("Sound",chara.Torso,"Slash",{SoundId = "rbxassetid://28144425",Pitch = .7,Volume = 5})
hitsnd = New("Sound",chara.Torso,"Hit",{SoundId = "rbxassetid://429400881",Pitch = .7,Volume = 5})
telesnd = New("Sound",chara.Torso,"Tele",{SoundId = "rbxassetid://2767090",Pitch = .7,Volume = 5})
burnsnd = New("Sound",chara.Torso,"Burn",{SoundId = "rbxassetid://32791565",Pitch = .7,Volume = 5})
music1 = New("Sound",chara.Torso,"Music1",{SoundId = "rbxassetid://151038517",Pitch = .5,Volume = 10,Looped = true})
music2 = New("Sound",chara.Torso,"Music2",{SoundId = "rbxassetid://11984351",Pitch = .2,Volume = 5,Looped = true})
deathmus = New("Sound",chara.Torso,"DeathMus",{SoundId = "rbxassetid://19094700",Pitch = .5,Volume = 5,Looped = true})
deathex = New("Sound",chara.Torso,"DeathEx",{SoundId = "rbxassetid://11984351",Pitch = 1,Volume = 5})
music1:Play()
music2:Play()
...
function Teleport(pos)
	...
	for i = 1, #ch do
		if ch[i].ClassName == "Part" and ch[i].Name ~= "HumanoidRootPart" then
			...
			local tracedisappear = coroutine.wrap(function()
				wait(1)
				for i = 1, 7 do
					wait(.1)
...
function Grab(mouse)
	...
	if hit ~= nil then
		if hit.Parent:FindFirstChild("Humanoid")~=nil then
			...
			for i = 1, 10 do
				wait(.1)
				local f = Instance.new("Fire", hit.Parent.Torso)
				f.Size = 15
				f.Heat = 50
				f.Color = Color3.new(1,0,0)
				f.SecondaryColor = Color3.new(0,0,0)
...
while true do
	...
	if chara.Humanoid.Health > 0 then
		...
		local f = Instance.new("Fire", jtrace)
		f.Color = Color3.new(1,0,0)
		f.SecondaryColor = Color3.new(0,0,0)
		f.Size = 6
